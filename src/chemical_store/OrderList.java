...
public Vector getItemData()
    {
        ...
        try
        {
        PreparedStatement pre = Con.prepareStatement("select * from product_order order by orderno");
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(chemical_store.Chemical_StoreApp.class).getContext().getResourceMap(OrderList.class);
